...
public class Wait {
    ...
    public static void defaultWait() throws InterruptedException{
//    	Thread.sleep(FileReaderManager.getInstance().getConfigReader().getImplicitlyWait());
    	Thread.sleep(3000);
    }
    
    public static void selfWait(int millis) throws InterruptedException{
    	Thread.sleep(millis);
    }
